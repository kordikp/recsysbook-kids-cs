...
Věž uživatelů: síť vezme vše o tobě a vytvoří jeden embedding. Věž položek: druhá síť vezme vše o videu a vytvoří embedding stejné velikosti. Jsou-li tvůj vektor a vektor videa blízko — systém předpovídá, že se ti bude líbit.
