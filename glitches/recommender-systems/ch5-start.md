...
Víš o doporučovacích systémech víc než většina dospělých. A teď přichází ta zábavná část: postavíš si vlastní.

Nepotřebuješ programovat. Na první verzi stačí tužka, papír a základní matematika. Plán jsou čtyři kroky: sbírej data, najdi podobné lidi, předpovídej a testuj.
